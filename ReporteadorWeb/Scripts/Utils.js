...
(function (self) {
    ...
    self.hexToBase64 = function (bytes) {
        var image = btoa([].reduce.call(new Uint8Array(bytes), function (p, c) { return p + String.fromCharCode(c) }, ''));
        var image = base64js.fromByteArray(bytes);
        return image;
    }
